...
function WeekView() {
  ...
  const [weekItemsCounter, setWeekItemsCounter] = useState<number>(1);
      ...
      <Fragment>
          ...
          <AccordionBody>
            <div className="overflow-y-auto py-4 px-3  rounded ">
              <ul className="space-y-2">
                ...
                <li>
                  <div className="grid grid-cols-12 gap-4 items-center	 p-2 text-gray-900 rounded-lg dark:text-black hover:bg-gray-100 ">
                    <div className="font-bold col-span-6 text-xl">
                      2. Quizess
                    </div>
        ...
        <Accordion open={open === 2}>
          ...
          <div className="mt-7 mb-7">
            <div
              onClick={() => {
                setWeekItems((prevNames) => [
                  ...prevNames,
                  weekItemsCounter + ". New Task",
                ]);
                setWeekItemsCounter((prevCounter) => prevCounter + 1);
              }}
              className="z-50 w-32 px-2 rounded-full ml-2 py-2 border-2 border-black items-center text-sm uppercase font-bold text-black hover:bg-black hover:text-white"
            >
              Create Tasks
            </div>
          </div>
